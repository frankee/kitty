...
func NewHTTPHandler(endpoints endpoints.AddEndPoints, otTracer stdopentracing.Tracer, zipkinTracer *stdzipkin.Tracer, logger log.Logger) http.Handler {
...
func NewHTTPClient(instance string, otTracer stdopentracing.Tracer, zipkinTracer *stdzipkin.Tracer, logger log.Logger) (addservice.Service, error) {
	...
	// of glue code.
	return endpoints.AddEndPoints {
		SumEndpoint:    sumEndpoint,
		ConcatEndpoint: concatEndpoint,
	}, nil
}

// decodeHTTPSumRequest is a grpc_transport/http.DecodeRequestFunc that decodes a
...
// decodeHTTPConcatRequest is a grpc_transport/http.DecodeRequestFunc that decodes a
...
// decodeHTTPSumResponse is a grpc_transport/http.DecodeResponseFunc that decodes a
...
// decodeHTTPConcatResponse is a grpc_transport/http.DecodeResponseFunc that decodes
...
// encodeHTTPGenericRequest is a grpc_transport/http.EncodeRequestFunc that
...
// encodeHTTPGenericResponse is a grpc_transport/http.EncodeResponseFunc that encodes
